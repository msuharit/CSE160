...
class Vector3 {
    ...
    static cross(other1, other2) {
        ...
        // used cross product formula from https://www.learningaboutelectronics.com/Articles/Cross-product-calculator-of-vectors.php
        var v1 = other1.elements
        var v2 = other2.elements
        var x = v1[0];
        var y = v1[1];
        ...
        var crossX = (y * z2) - (z * y2)
        // negative sign not needed
        var crossY = (z * x2) - (x * z2)
        var crossZ = (x * y2) - (y * x2)
    ...
    normalize() {
        ...
        // divide vector by its magnitude if not 0 length
        if (len != 0){
          this.div(len)
        }
